      ...
      <div className="modal" onClick={() => { setOpenModal(false); }}>
        ...
        <div className="card" style={{width: '600px', borderRadius: "8px"}} onClick={(e) => e.stopPropagation()}>
          <div className="card-body">
            ...
            <form method="post" onSubmit={(e) => handleSubmit(e, thisList().ASSETS_NUM)}>

              <fieldset className="row mb-3">
                <legend className="col-form-label col-sm-2 pt-0">요청종류</legend>
                <div className="col-sm-10">
                  <div className="form-check">
                    <input className="form-check-input" type="radio" name="return_kind" id="gridRadios1" value="교환" onChange={handleChange}/>
              ...
              <div className="row mb-3 position-relative">
                ...
                <div className="col-sm-10">
                  ...
                  <input type="text" className="form-control" name="return_title" id="validationTooltip01" onChange={handleChange} value={inputTitle} required />
              ...
              <div className="row mb-3">
                ...
                <div className="col-sm-10">
                  ...
                  <textarea className="form-control userModalAst-text" name="return_comment" onChange={handleChange} value={inputComment} required></textarea>
                </div>
              </div>
