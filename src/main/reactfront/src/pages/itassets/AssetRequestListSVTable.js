...
const AssetRequestListSVTable = ({index, currentPage, itemsPerPage,
                                     ...
                                     username, appro_title, appro_comment, category_num, assets_detail_name,
                                     func, handleModal, todayTime
                                 }) => {
    let categoryName;
    switch (category_num) {
        case 5:case 6:
    ...
    return (
        <tr className="prod-box">
            ...
            <td className="spec_mfg">{server_mfg}</td>
            <td className="spec_seriel">{assets_detail_name}</td>
            <td className="spec_warranty">{server_spec_warranty}</td>
